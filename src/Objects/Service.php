...
class Service
{
     ...
     */
    public function __construct(?int $dataId, ?int $id, ?string $startDate, ?string $endDate, ?int $price, ?string $priceType, ?string $deactivatedOn, ?string $description, ?string $runtime, ?string $name, ?string $type, ?int $templateId, ?int $realPrice, ?int $serviceGroupId)
    {
        $this->dataId = $dataId;
        $this->id = $id;
    ...
    public static function fromStdClass(object $object):Service
    {
        ...
        return new Service($dataId, $id, $startDate, $endDate, $price, $priceType, $deactivatedOn, $description, $runtime, $name, $type, $templateId, $realPrice, $serviceGroupId);
     }
